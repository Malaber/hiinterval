...
release_dir=$(mktemp -d "${temp_base%/}/hiinterval-testflight.XXXXXX")
archive_path="$release_dir/HiInterval-$marketing_version-$build_number.xcarchive"
...
env PATH=/usr/bin:/bin:/usr/sbin:/sbin /usr/bin/xcodebuild \
  ...
  PRODUCT_BUNDLE_IDENTIFIER=de.malaber.hiinterval \
